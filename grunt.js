...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      libs: {
        src: ['js/lib/underscore.1.4.3.min.js', 'js/lib/jquery.1.8.3.min.js', 'js/lib/jquery.jsonp-2.4.0.min.js', 'js/lib/backbone.0.9.10.min.js', 'js/lib/tabletop.master-20130121.min.js', 'js/lib/moment.2.0.0.min.js'],
